...
- [Normalisr](https://github.com/lingfeiwang/normalisr) - [software, Python, Shell] - Single-cell CRISPR screen (e.g. Perturb-seq, CROP-seq) analysis for robust, efficient gene differential expression and regulatory network reconstruction with accurate FDR control. [Nature Communications 2021](https://doi.org/10.1038/s41467-021-26682-1).
